...
<%
  ...
  String schooolAreaName=Util.getSchoolAreaNameById(orgId);
  WeixinUtil appUtil = new WeixinUtil();
  WeixinParams wxParams = appUtil.getWeixinParamsByOrganizationId(orgId);
  if(wxParams != null){
	session.setAttribute("orgId", orgId);
	session.setAttribute("schoolAreaName", schooolAreaName);
    String redirect_uri = wxParams.getDomainName() + request.getContextPath() + "/m/trainerReservation1.jsp";
