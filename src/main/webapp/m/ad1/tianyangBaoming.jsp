...
<%
  ...
  if(!Util.isNotNull(orgId)) orgId = "c0510169-8edc-470e-b038-c299c7735bty";
...
<meta name="apple-mobile-web-app-title" content="广西驰程威龙驾校(田阳)">
<meta name="description" content="广西驰程威龙驾校(田阳)开学学车大优惠,C1学费4500,C2学费4500">
<meta itemprop="name" content="广西驰程威龙驾校(田阳)开学学车大优惠">
<meta itemprop="description" content="广西驰程威龙驾校(田阳)开学学车大优惠，最低至:3700元">
<meta itemprop="image" content="http://ccjx.tc1680.com/driverschool/m/ad1/file/logo.jpg">
<title>广西驰程威龙驾校(田阳)</title>
...
<body>
    ...
    <div class="swiper-wrapper">
      <section class="swiper-slide swiper-slide1">
        ...
        <span class="ani resize" style="width:320px;left:0px;top:280px;z-index:4;font-weight:bold;text-align:center;font-size:26px;color:#FF8C00;" swiper-animate-effect="fadeInUp"
          swiper-animate-duration="0.5s" swiper-animate-delay="0.5s">广西驰程威龙驾校(田阳)</span> 
      </section>
      <section class="swiper-slide swiper-slide2">
        <span class="ani resize" style="width:320px;left:0px;top:60px;z-index:4;font-weight:bold;letter-spacing:4px;font-size:22px;text-align:center" swiper-animate-effect="bounceInDown"
          swiper-animate-duration="1.5s" swiper-animate-delay="0.2s">广西驰程威龙驾校(田阳)开学大优惠</span>
        <span class="ani resize" style="width:260px;left:30px;top:120px;z-index:4;font-weight:bold;letter-spacing:4px;font-size:20px;" swiper-animate-effect="zoomIn"
          swiper-animate-duration="1.0s" swiper-animate-delay="1.0s">　　广西驰程威龙驾校(田阳)，为庆祝我校顺利开业，我校决定开展优惠活动，给广大学员带来福利！<br/>
          　即日起到学校报名均可享受优惠活动，<span style="color:#FF8C00;">C1学费4500,C2学费4500,C2活动价火热进行中...</span><br/>
          <span class="ani resize" swiper-animate-effect="flash"
            swiper-animate-duration="1.0s" swiper-animate-delay="2.0s">
            　　<span style="color:#FF8C00;">广西驰程威龙驾校(田阳)期待您的到来！！！</span><br/>
        </span>
      ...
      <section class="swiper-slide swiper-slide3">
        <span class="ani resize" style="width:320px;left:0px;top:40px;z-index:4;font-weight:bold;letter-spacing:4px;font-size:24px;text-align:center" swiper-animate-effect="bounceInDown"
          swiper-animate-duration="1.5s" swiper-animate-delay="0.2s">广西驰程威龙驾校(田阳)</span>
        <span class="ani resize" style="width:260px;left:30px;top:90px;z-index:4;font-weight:bold;letter-spacing:4px;font-size:16px;" swiper-animate-effect="bounceInUp"
          swiper-animate-duration="1.0s" swiper-animate-delay="1.0s">　学校简介 田阳威龙驾校是一家专业的机动车驾驶员培训机构。学校报名地点，训练场地位于敢壮大道新汽车客运总站旁（新交警对面）,交通便利,场地设备新颖，环境优美,风景宜人。学校凭借“以人为本，服务第一”的教学宗旨，学校实行一人一车一教练，一车一库位，还提供晚上练车的训练场地，您可以合理安排练车时间，实现学车工作两不误。让学员完全满意的经营理念，让您毕业后真正的会开车，享受驾驶的乐趣。<br/>
        </span>
      </section>
  ...
  <script type="text/javascript">
    ...
    var title = "广西驰程威龙驾校(田阳)开学学车大优惠"; // 分享标题
    var desc = "广西驰程威龙驾校(田阳)开学学车大优惠，微信分享送学时..."; // 分享描述
    var link = "http://ccjx.tc1680.com/driverschool/m/ad1/tianyangBaoming.jsp"; // 分享链接
