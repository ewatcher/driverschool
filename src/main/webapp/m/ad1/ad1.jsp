...
<meta name="description" content="广西驰程交通驾校开学学车大优惠">
<meta itemprop="name" content="广西驰程交通驾校开学学车大优惠">
<meta itemprop="description" content="广西驰程交通驾校开学学车大优惠">
  ...
  <div class="resize swiper-container" style="background:url(file/background.jpg) no-repeat left top;background-size:100% 100%;">
    <div class="swiper-wrapper">
      <section class="swiper-slide swiper-slide1">
        <img src="file/b1.png" class="ani resize" style="width:320px;height:480px;z-index:3;" swiper-animate-effect="pulse"
      ...
      <section class="swiper-slide swiper-slide2">
        <span class="ani resize" style="width:320px;left:0px;top:30px;z-index:4;font-weight:bold;letter-spacing:4px;font-size:22px;text-align:center" swiper-animate-effect="bounceInDown"
          swiper-animate-duration="1.5s" swiper-animate-delay="0.2s">驰程交通驾校</span>
        <span class="ani resize" style="width:260px;left:30px;top:90px;z-index:4;font-weight:bold;letter-spacing:4px;font-size:16px;" swiper-animate-effect="zoomIn"
          swiper-animate-duration="1.0s" swiper-animate-delay="1.0s">　　
            1.标准化训练场地，严格按照考场场地标准自建，让学员的每一次练习都是模拟考试。<br/>
          　　2.专享VIP一人一车的练车模式，将精湛的驾驶和丰富的驾驶经验一一传教，报名即可上车，你的学车时间由你做主，考试名额多，保证学员最快拿到驾照。<br/>
          　　3.教练专业、高素质、教学经验丰富，学员通过率高；性格幽默风趣，朋友式教学，不吃拿卡要。<br/>
          　　4.价格优惠，收费透明，一次性收费，后期无其他费用。<br/>
        </span>
