...
<body>
  ...
  <article data-am-widget="paragraph" class="am-paragraph am-paragraph-default"
    data-am-paragraph="{ tableScrollable: false, pureview: true }">
    
    <div class="am-article-hd" style="padding-top:20px;">
      <h1 class="am-article-title" style="margin-bottom:5px;">在线复习</h1>
    </div>
