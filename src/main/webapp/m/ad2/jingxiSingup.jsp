...
<div class="box">
  ...
  <div class="top"><h2>老牌驾校、服务好、得证快，交通便利，特方便！</h2></div>
  <p class="time">靖西人民的驾校</p>
  <div class="gr"><img src="images/top.png"></div>
     <div class="car"><p>广西驰程众安驾校欢迎您</p></div>   
     <div class="cheats"><img src="images/cheats.png"></div>
     <div class="favourable"><img src="images/favourable.png">
       <p>众安驾校开业活动<br><span class="w2">大优惠</span><br>1.开业期间学费5200/人；
       <br>2.团体优惠：3人以上5人以下每位学员优惠100元,5人以上每位学员优惠200元；<br>
       <br>3.学费分期付款,报名首付3000元，考科目三前付完余款；<br>
       </p>
  </div>
  <div class="banner1"><img src="images/jxsingup.jpg"></div>
  <div class="book"><img src="images/book.png">
    <p>1.标准化训练场地严格按照考场场地标准自建，让学员的每一次练习都是模拟考试。<br>
     ...
     <div class="slogan"><img src="images/slogan.png"></div>
     	<div class="w7"><img src="images/singup.jpg"></div>
     	<div class="w7"><img src="images/door.jpg"></div>
     	<div class="w7"><img src="images/car.jpg"></div>
    	 <div class="w7"><img src="images/trainer.jpg"></div>
...
<div class="bootm"><img src="images/13.jpg">
        <p>
           <span class="qq">联系我们</span><br>
           		广西驰程众安驾校<br>
              报名热线：0776-6450066<br>
              报名地址：广西靖西市安德镇三合乡三合街（原高速路料场）<br>
  ...
  <script type="text/javascript">
    ...
    var link = "http://ccjx.tc1680.com/driverschool/m/ad2/jingxiSingup.jsp"; // 分享链接
    var imgUrl = "http://ccjx.tc1680.com/driverschool/m/ad2/images/jxsingup.jpg"; // 分享图标
