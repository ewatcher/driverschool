...
<body style="font-size: 1.2rem;">
  ...
  <div style="margin:10px 10px 0px 10px;">
    ...
    <c:if test="${orgId!='c0510169-8edc-470e-b038-c299c7735bty' }">
      ...
      <li><a href="${pageContext.request.contextPath}/m/ureservation.jsp" class="am-icon-btn am-success am-icon-recycle"></a><br /> 取消预约</li>
  ...
  <div class="am-panel am-panel-secondary" style="margin-bottom:0px;">
    <div class="am-panel-hd">
      <span class="am-icon-commenting-o" style="margin-right:10px;"></span>教练对我的点评
    </div>
    <div class="am-form">
      <fieldset>
              ...
              <c:when test="${!empty commentList}">
                <c:forEach var="row" items="${commentList}" varStatus="status">
                  <div class="am-panel am-panel-success">
                    <div class="am-panel-hd">教练 ${row.trainName} 于  ${row.commentTime} 对您做出了评价</div>
