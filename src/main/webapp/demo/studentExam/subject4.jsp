...
<script type="text/javascript" charset="utf-8">
	...
	function initStudentExamDatagrid(examAnalysId,batch,addStudentExamDialog,schoolArea){
		...
		studentExamDatagrid.datagrid({
			...
			queryParams:{batch:batch,subjectType:4},
			iconCls : 'icon-save',
			pagination : true, 
			pagePosition : 'bottom', 
			pageSize : 20, 
		...
		<table id="demo_examAnalys_datagrid" class="easyui-datagrid" title="学员考试信息列表" 
			...
			<thead >
				<tr >
 				...
 				<tr>	
					<th data-options="field:'subject4ExamDate',width:100,align:'center',editor:'datebox',formatter:formatTimeYMD" id="sub4font1">考试日期</th>
