...
<div style="padding: 5px;overflow: hidden ;height:485px">
	<form id="demo_qualificationLicense_addForm" method="post">
	...
	<fieldset >
		...
		<table class="tableForm">
			...
			<tr>
				<td colspan="8">
					<a href="javascript:void(0);" id="qualificationLicense_a_searche"  >查询</a>
					<a href="javascript:void(0);" id="qualificationLicense_a_cancel" >重置</a>
				</td>
			</tr>
		</table>
	</fieldset>
	<fieldset style="height:380px;">
		<legend >符合领取资格证学员信息列表</legend>
		<table id="demo_qualificationLicense_selectStudent" class="tableForm"></table>
	</fieldset>
	</form>
</div>