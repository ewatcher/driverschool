...
<div style="padding: 5px;overflow: hidden;">
	...
	<input name="prevateDate" type="hidden"/>
	...
	<fieldset >
		...
		<table class="tableForm">
			<tr>
				...
				<td ><input name="state" style="width: 150px;" /></td>
			...
			<tr><td colspan="8"><textarea name="remarks" style="height: 100px;width: 98%;"></textarea></td></tr>
		</table>
	</fieldset>
