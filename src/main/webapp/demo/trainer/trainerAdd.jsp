	...
	<fieldset >
		...
		<table class="tableForm">
			...
			<tr>
				...
				<td><input name="email" class="easyui-validatebox" data-options="validType:'email',missingMessage:'请填写学员身手机号'" type="email" /></td>
			...
			<tr>
				...
				<td><input name="nation" class="easyui-validatebox" data-options="validType:'validChinese'" /></td>
				<th style="width: 55px;">籍贯:</th>
				<td><input name="contry" class="easyui-validatebox" data-options="validType:'validChinese'"/></td>
		...
		<legend>教练驾驶资料</legend>
			<table class="tableForm">
				<tr>
					...
					<th style="width: 65px;">准驾类型:</th>
					<td><input name="driverType" style="width:155px;"/></td>
					<th style="width: 65px;">准驾教车型:</th>
