		...
		<fieldset >
			...
			<table class="tableForm">
				...
				<tr>
					...
					<td><input name="keyname" class="easyui-validatebox" data-options="required:'true',missingMessage:'请输入配置标识'" style="width:150px;" />
				...
				<tr>
					<td colspan="8"><textarea name="config" style="height: 100px;width: 98%;"></textarea></td>
				</tr>
			</table>
		</fieldset>
