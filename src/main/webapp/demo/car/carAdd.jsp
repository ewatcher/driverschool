	...
	<fieldset >
		...
		<table class="tableForm">
			<tr>
				...
				<td><input name="licenseNo"  class="easyui-validatebox" data-options="required:'true',missingMessage:'请填写行驶证号'" /></td>
				<th style="width: 70px;">车辆型号:</th>
				<td><input name="vehicleType"  /></td>
			</tr>	
			<tr>
				<th style="width: 70px;">车辆用途:</th>
				<td><input name="carType" style="width: 150px;"  /></td>
				<th style="width: 70px;">使用状态:</th>
				<td><input name=usingState  style="width: 150px;" />
				</td>
				<th style="width: 70px;">使用类型:</th>
				<td><input name="useType" style="width: 150px;" />
				</td>
				<th style="width: 70px;">车辆品牌:</th>
				<td><input name="vehicleBrands"  /></td>
			</tr>
			<tr>
				<th style="width: 70px;">运输证号:</th>
				<td><input name="transportNo"  /></td>
			...
			<tr>
				...
				<td colspan="6"><textarea name="comment" style="height: 100px;width: 98%;"></textarea></td>
			</tr>
