...
<script type="text/javascript" charset="utf-8">
	...
	$(function() {
		...
		mydatagrid = $('#demo_person_datagrid').datagrid({
			url : '${pageContext.request.contextPath}/demo/personAction!datagrid.action',/* 从后台读取所有user数据 */
			...
			columns : [ [{
				...
				field : 'sex',
				sortable : true,
				width : 40 //在datagrid中一定要添加列宽度，否则会加长datagrid渲染的时间，消耗系统资源
			},{
				...
				title : '<font color="#0099FF">户口性质</font>',
				field : 'accountNature',
				sortable : true,
				width : 100
			}, {
				...
				title : '<font color="#0099FF">政治面貌</font>',
				field : 'political',
				sortable : true,
				width : 100
			}, {
				title : '<font color="#0099FF">专业</font>',
				field : 'profession',
				sortable : true,
				width : 150
			}, {
				title : '<font color="#0099FF">文化程度</font>',
				field : 'educationLevel',
				sortable : true,
				width : 150
			},{
				title : '<font color="#0099FF">毕业学校</font>',
				...
				title : '<font color="#0099FF">外语等级</font>',
				field : 'languageLevel',
				sortable : true,
				width : 150
			},{
				title : '<font color="#0099FF">计算机等级</font>',
				field : 'computerLevel',
				sortable : true,
				width : 150
			},{
				title : '<font color="#0099FF">初次工作日期</font>',
				field : 'startedJob',
				sortable : true,
				width : 100,
				align : 'center',
				...
				title : '<font color="#0099FF">录用日期</font>',
				field : 'employDay',
				sortable : true,
				width : 90,
				align : 'center',
				...
				title : '<font color="#0099FF">婚姻状况</font>',
				field : 'marriageState',
				sortable : true,
				width : 70
			}, {
				title : '<font color="#0099FF">驾照等级</font>',
				field : 'driverLevel',
				sortable : true,
				width : 70
			},{
			...
			onLoadSuccess : function (data) {
				...
				$(this).datagrid('hideColumn','schoolAreaId');
				initSchoolArea($("#demo_personDepartment"),userSchoolArea);
				//datagrid没有数据时显示没有记录信息
				if(data.total==0){
					$(this).datagrid('appendRow', {
						departmentId: '<div style="text-align:center;color:red">没有记录信息！</div>' })
					.datagrid('mergeCells', { index: 0, field: 'departmentId', colspan:14 });
				}
			},
			//右键菜单所触发的事件
	...
	<div data-options="region:'north',border:false,title:'查询功能'" style="height: 90px;overflow: hidden;" align="left">
		...
		<form id="demo_person_searchForm">
			...
			<table class="tableForm datagrid-toolbar" style="width: 100%;height: 100%;">
				<tr>
					<th>所属部门：</th>
					<td><input id="demo_personDepartment" name="departmentId" style="width:150px;" />
	 					</td>
					<th >姓名:</th>
					<td><input name="name" class="input_clean" style="width:150px;" /></td>
					<th>身份证号：</th>
					<td><input name="identityId" class="input_clean"  style="width:150px;" /></td>
				</tr>
				<tr>
					<th>职务：</th>
					<td><input name="duty" class="input_clean"  style="width:150px;" /></td>
					<td colspan="2">
