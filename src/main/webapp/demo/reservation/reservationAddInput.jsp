	...
	<fieldset >
		...
		<table class="tableForm">
			<tr>
				<th>发放日期:</th>
				<td>
					<input name="grantDate" class="easyui-datetimebox" data-options="showSeconds: false,editable:false"
					 style="width: 155px;" />
				</td>
				<th>初领日期:</th>
				<td>
					<input name="firstGetDate" class="easyui-datetimebox" data-options="showSeconds: false,editable:false"
					 style="width: 155px;" />
				</td>
				...
				<th>有效开始日期:</th>
				<td>
					<input name="validBeginDate" class="easyui-datetimebox" data-options="showSeconds: false,editable:false"
					 style="width: 155px;" />
				</td>
			</tr>
			<tr>
				...
				<th>领取日期:</th>
				<td>
					<input name="recieveDate" class="easyui-datetimebox" data-options="showSeconds: false,editable:false"
					 style="width: 155px;" />
				</td>
			</tr>
		</table>
