...
<div style="padding: 5px;overflow: hidden;">
	<form id="demo_driverLicensel_updateForm" method="post">
	...
	<fieldset >
		...
		<table class="tableForm">
			<tr>
				...
				<td ><input class="demo_driverLicense_update" name="studentOrganization" /></td>
			...
			<tr>
				...
				<td ><input class="demo_driverLicense_update" name="studentDriverType"  style="width: 155px;"/></td>
			</tr>
		</table>
	</fieldset>
	<fieldset >
		...
		<table class="tableForm">
			...
			<tr>
				...
				<td><input name="validYear" class="demo_driverLicense_update" style="width: 155px;"/></td>
				<th style="width: 70px;">领取状态:</th>
				<td>
					<select class="demo_driverLicense_update" name="grantState" disabled="true" style="width:155px;">
